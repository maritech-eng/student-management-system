// Auto-generated CRUD screen for Leave Requests
requireAuth();

const ENDPOINT = "/api/leaves";
const FIELDS = [{name:"applicantId", label:"Applicant Id", type:"text"}, {name:"applicantType", label:"Applicant Type", type:"text"}, {name:"fromDate", label:"From Date", type:"date"}, {name:"toDate", label:"To Date", type:"date"}, {name:"reason", label:"Reason", type:"text"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Leave Requests: " + err.message, "danger");
  }
}
...
const COLUMNS = ["applicantId", "applicantType", "fromDate", "toDate", "status"];
...
function openAddModal() {
  editingId = null;
  document.getElementById("formModalTitle").textContent = "Add Leave Request";
  FIELDS.forEach(f => {
...
async function editRecord(id) {
  ...
  if (!item) return;
  document.getElementById("formModalTitle").textContent = "Edit Leave Request";
  FIELDS.forEach(f => {
    const el = document.getElementById("f_" + f.name);
