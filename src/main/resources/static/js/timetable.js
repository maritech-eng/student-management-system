// Auto-generated CRUD screen for Timetable
requireAuth();

const ENDPOINT = "/api/timetable";
const FIELDS = [{name:"departmentId", label:"Department Id", type:"text"}, {name:"courseId", label:"Course Id", type:"text"}, {name:"semester", label:"Semester", type:"number"}, {name:"section", label:"Section", type:"text"}, {name:"day", label:"Day", type:"text"}, {name:"time", label:"Time", type:"text"}, {name:"subjectId", label:"Subject Id", type:"text"}, {name:"facultyId", label:"Faculty Id", type:"text"}, {name:"roomNumber", label:"Room Number", type:"text"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Timetable: " + err.message, "danger");
  }
}
...
const COLUMNS = ["departmentId", "semester", "section", "day", "time", "subjectId"];
...
function openAddModal() {
  editingId = null;
  document.getElementById("formModalTitle").textContent = "Add Timetable Entry";
  FIELDS.forEach(f => {
...
async function editRecord(id) {
  ...
  if (!item) return;
  document.getElementById("formModalTitle").textContent = "Edit Timetable Entry";
  FIELDS.forEach(f => {
    const el = document.getElementById("f_" + f.name);
