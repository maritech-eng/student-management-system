// Auto-generated CRUD screen for Fees
requireAuth();

const ENDPOINT = "/api/fees";
const FIELDS = [{name:"studentId", label:"Student Id", type:"text"}, {name:"academicYear", label:"Academic Year", type:"text"}, {name:"semester", label:"Semester", type:"number"}, {name:"tuitionFee", label:"Tuition Fee", type:"number"}, {name:"examFee", label:"Exam Fee", type:"number"}, {name:"hostelFee", label:"Hostel Fee", type:"number"}, {name:"transportFee", label:"Transport Fee", type:"number"}, {name:"otherFee", label:"Other Fee", type:"number"}, {name:"paidAmount", label:"Paid Amount", type:"number"}, {name:"paymentDate", label:"Payment Date", type:"date"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Fees: " + err.message, "danger");
  }
}
...
const COLUMNS = ["studentId", "academicYear", "totalFee", "paidAmount", "pendingAmount", "paymentStatus"];
...
function openAddModal() {
  editingId = null;
  document.getElementById("formModalTitle").textContent = "Add Fee Record";
  FIELDS.forEach(f => {
...
async function editRecord(id) {
  ...
  if (!item) return;
  document.getElementById("formModalTitle").textContent = "Edit Fee Record";
  FIELDS.forEach(f => {
    const el = document.getElementById("f_" + f.name);
