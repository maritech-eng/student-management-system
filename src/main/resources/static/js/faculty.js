// Auto-generated CRUD screen for Faculty
requireAuth();

const ENDPOINT = "/api/faculty";
const FIELDS = [{name:"facultyCode", label:"Faculty Code", type:"text"}, {name:"name", label:"Name", type:"text"}, {name:"email", label:"Email", type:"text"}, {name:"phone", label:"Phone", type:"text"}, {name:"departmentId", label:"Department Id", type:"text"}, {name:"designation", label:"Designation", type:"text"}, {name:"qualification", label:"Qualification", type:"text"}, {name:"joiningDate", label:"Joining Date", type:"date"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Faculty: " + err.message, "danger");
  }
}
...
const COLUMNS = ["facultyCode", "name", "email", "departmentId", "designation"];
...
function openAddModal() {
  editingId = null;
  document.getElementById("formModalTitle").textContent = "Add Faculty Member";
  FIELDS.forEach(f => {
...
async function editRecord(id) {
  ...
  if (!item) return;
  document.getElementById("formModalTitle").textContent = "Edit Faculty Member";
  FIELDS.forEach(f => {
    const el = document.getElementById("f_" + f.name);
