// Auto-generated CRUD screen for Exams
requireAuth();

const ENDPOINT = "/api/exams";
const FIELDS = [{name:"examName", label:"Exam Name", type:"text"}, {name:"subjectId", label:"Subject Id", type:"text"}, {name:"semester", label:"Semester", type:"number"}, {name:"examDate", label:"Exam Date", type:"date"}, {name:"maxMarks", label:"Max Marks", type:"number"}];
...
const COLUMNS = ["examName", "subjectId", "semester", "examDate", "maxMarks"];
...
function openAddModal() {
  editingId = null;
  document.getElementById("formModalTitle").textContent = "Add Exam";
  FIELDS.forEach(f => {
...
async function editRecord(id) {
  ...
  if (!item) return;
  document.getElementById("formModalTitle").textContent = "Edit Exam";
  FIELDS.forEach(f => {
    const el = document.getElementById("f_" + f.name);
