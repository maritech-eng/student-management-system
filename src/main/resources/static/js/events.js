// Auto-generated CRUD screen for Events
requireAuth();

const ENDPOINT = "/api/events";
const FIELDS = [{name:"eventName", label:"Event Name", type:"text"}, {name:"description", label:"Description", type:"text"}, {name:"date", label:"Date", type:"date"}, {name:"time", label:"Time", type:"text"}, {name:"venue", label:"Venue", type:"text"}, {name:"organizer", label:"Organizer", type:"text"}];
...
const COLUMNS = ["eventName", "date", "time", "venue"];
