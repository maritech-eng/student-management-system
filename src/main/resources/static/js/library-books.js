// Auto-generated CRUD screen for Library - Books
requireAuth();

const ENDPOINT = "/api/library/books";
const FIELDS = [{name:"isbn", label:"Isbn", type:"text"}, {name:"title", label:"Title", type:"text"}, {name:"author", label:"Author", type:"text"}, {name:"category", label:"Category", type:"text"}, {name:"publisher", label:"Publisher", type:"text"}, {name:"quantity", label:"Quantity", type:"number"}, {name:"availableQuantity", label:"Available Quantity", type:"number"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Library - Books: " + err.message, "danger");
  }
}
...
const COLUMNS = ["isbn", "title", "author", "category", "availableQuantity"];
