// Auto-generated CRUD screen for Departments
requireAuth();

const ENDPOINT = "/api/departments";
const FIELDS = [{name:"departmentCode", label:"Department Code", type:"text"}, {name:"name", label:"Name", type:"text"}, {name:"hodName", label:"Hod Name", type:"text"}, {name:"description", label:"Description", type:"text"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Departments: " + err.message, "danger");
  }
}
...
const COLUMNS = ["departmentCode", "name", "hodName"];
