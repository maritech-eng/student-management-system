// Auto-generated CRUD screen for Staff
requireAuth();

const ENDPOINT = "/api/staff";
const FIELDS = [{name:"staffCode", label:"Staff Code", type:"text"}, {name:"name", label:"Name", type:"text"}, {name:"email", label:"Email", type:"text"}, {name:"phone", label:"Phone", type:"text"}, {name:"gender", label:"Gender", type:"text"}, {name:"dob", label:"Dob", type:"date"}, {name:"address", label:"Address", type:"text"}, {name:"departmentId", label:"Department Id", type:"text"}, {name:"designation", label:"Designation", type:"text"}, {name:"joiningDate", label:"Joining Date", type:"date"}, {name:"qualification", label:"Qualification", type:"text"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Staff: " + err.message, "danger");
  }
}
...
const COLUMNS = ["staffCode", "name", "email", "departmentId", "designation"];
...
function openAddModal() {
  editingId = null;
  document.getElementById("formModalTitle").textContent = "Add Staff Member";
  FIELDS.forEach(f => {
...
async function editRecord(id) {
  ...
  if (!item) return;
  document.getElementById("formModalTitle").textContent = "Edit Staff Member";
  FIELDS.forEach(f => {
    const el = document.getElementById("f_" + f.name);
