// Auto-generated CRUD screen for Subjects
requireAuth();

const ENDPOINT = "/api/subjects";
const FIELDS = [{name:"subjectCode", label:"Subject Code", type:"text"}, {name:"name", label:"Name", type:"text"}, {name:"departmentId", label:"Department Id", type:"text"}, {name:"courseId", label:"Course Id", type:"text"}, {name:"semester", label:"Semester", type:"number"}, {name:"credits", label:"Credits", type:"number"}, {name:"facultyId", label:"Faculty Id", type:"text"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Subjects: " + err.message, "danger");
  }
}
...
const COLUMNS = ["subjectCode", "name", "departmentId", "semester", "credits"];
