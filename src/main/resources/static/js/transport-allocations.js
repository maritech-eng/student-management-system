// Auto-generated CRUD screen for Transport Allocations
requireAuth();

const ENDPOINT = "/api/transport/allocations";
const FIELDS = [{name:"studentId", label:"Student Id", type:"text"}, {name:"busId", label:"Bus Id", type:"text"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Transport Allocations: " + err.message, "danger");
  }
}
...
const COLUMNS = ["studentId", "busId", "allocationDate"];
