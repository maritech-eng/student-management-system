// Auto-generated CRUD screen for Courses
requireAuth();

const ENDPOINT = "/api/courses";
const FIELDS = [{name:"courseCode", label:"Course Code", type:"text"}, {name:"name", label:"Name", type:"text"}, {name:"departmentId", label:"Department Id", type:"text"}, {name:"duration", label:"Duration", type:"text"}, {name:"description", label:"Description", type:"text"}];
...
const COLUMNS = ["courseCode", "name", "departmentId", "duration"];
...
function openAddModal() {
  editingId = null;
  document.getElementById("formModalTitle").textContent = "Add Course";
  FIELDS.forEach(f => {
