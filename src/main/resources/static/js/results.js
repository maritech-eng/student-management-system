// Auto-generated CRUD screen for Results
requireAuth();

const ENDPOINT = "/api/results";
const FIELDS = [{name:"studentId", label:"Student Id", type:"text"}, {name:"examId", label:"Exam Id", type:"text"}, {name:"subjectId", label:"Subject Id", type:"text"}, {name:"marks", label:"Marks", type:"number"}, {name:"maxMarks", label:"Max Marks", type:"number"}, {name:"credits", label:"Credits", type:"number"}];
...
async function loadRecords() {
  try {
    ...
    showAlert("Failed to load Results: " + err.message, "danger");
  }
}
...
const COLUMNS = ["studentId", "examId", "subjectId", "marks", "maxMarks", "grade"];
...
function openAddModal() {
  editingId = null;
  document.getElementById("formModalTitle").textContent = "Add Result";
  FIELDS.forEach(f => {
...
async function editRecord(id) {
  ...
  if (!item) return;
  document.getElementById("formModalTitle").textContent = "Edit Result";
  FIELDS.forEach(f => {
    const el = document.getElementById("f_" + f.name);
